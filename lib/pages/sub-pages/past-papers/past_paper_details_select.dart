...
class PaperDetailsSelectionPage extends StatefulWidget {
  ...
  @override
  PaperDetailsSelectionPageState createState() => new PaperDetailsSelectionPageState();
}
...
class PaperDetailsSelectionPageState extends State<PaperDetailsSelectionPage> {
  ...
  List<int> componentsList = [11, 12, 23, 24,];
  ...
  Step _buildPaperSelectionStep(){
    ...
    return new Step(
      ...
      content: new Column(
        ...
        children: <Widget>[
          new Center(child: new Text("Select the component of the paper you seek.")),
          new Padding(padding: new EdgeInsets.symmetric(vertical: 10.0),),
          new Divider(),
          new ListTile(
