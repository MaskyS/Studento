...
void handleonTap(BuildContext context, String subjectName, String level,
    String onTapFunction,
    {Map urlList}) {
  Navigator.pop;
  ...
  switch (onTapFunction) {
      ...
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (BuildContext context) =>
                new PaperDetailsSelectionPage(subjectName, level)),
      );
      break;
    ...
    case 'topicNotesPage':
      ...
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (BuildContext context) =>
                new TopicSelectPage(subjectName, level)),
      );
      break;
